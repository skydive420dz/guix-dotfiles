...
(global-set-key (kbd "C-c o a") #'sk/audio)
...
(use-package general
  ...
  (rune/leader-keys
    ...
    "lS" '(:ignore t :which-key "scheme studio")
    "lSh" '(sk/scheme-studio-hint :which-key "hint")
    "lSn" '(sk/scheme-studio-next :which-key "next")
    "lSo" '(sk/scheme-studio :which-key "open")
    "lSp" '(sk/scheme-studio-progress :which-key "progress")
    "lSr" '(sk/scheme-studio-reset :which-key "reset")
    "lSt" '(sk/scheme-studio-test :which-key "test")
